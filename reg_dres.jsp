...
String dtype=request.getParameter("D1");
...
PreparedStatement ps1=con.prepareStatement("SELECT max(DonorID) FROM Donors");
...
PreparedStatement ps2=con.prepareStatement("insert into DONORS (DONORID,DNAME,PAN,GENDER,DTYPE,ADDRESS,EMAIL,PHONE,Password) values (?,?,?,?,?,?,?,?,?)");
ps2.setInt(1,ID);
ps2.setString(2,Name);
ps2.setString(3,PAN);
ps2.setString(4,Sex);
ps2.setString(5,dtype);
